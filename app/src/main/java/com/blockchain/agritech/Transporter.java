...
import com.blockchain.agritech.databinding.ActivityTransporterBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this)
                ...
                .into(new CustomViewTarget<ConstraintLayout, Drawable>(frameLayout) {
                    ...
                    public void onLoadFailed(@Nullable Drawable errorDrawable) {
                        Toast.makeText(Transporter.this, "Load Failed", Toast.LENGTH_SHORT).show();
                    }
        ...
        binding.textView7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Transporter.this, Place_Bid.class);
                startActivity(i);
            }
        });
        binding.textView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Transporter.this, Transporter_View_Jobs.class);
                startActivity(i);
            }
        });
    }
