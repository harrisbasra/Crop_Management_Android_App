...
import com.blockchain.agritech.databinding.ActivityFarmerBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this)
                ...
                .into(new CustomViewTarget<ConstraintLayout, Drawable>(frameLayout) {
                    ...
                    public void onLoadFailed(@Nullable Drawable errorDrawable) {
                        Toast.makeText(Farmer.this, "Load Failed", Toast.LENGTH_SHORT).show();
                    }
        ...
        binding.textView7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Farmer.this, FarmerUploadRate.class);
                startActivity(i);
            }
        });
        ...
        binding.textView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Farmer.this, Farmer_View_1.class);
                startActivity(i);
            }
        });
    }
