...
import com.blockchain.agritech.databinding.ActivityContractorOptionMenuBinding;
 ...
 */
public class Contractor_Option_Menu extends AppCompatActivity {
    /**
    ...
    private ActivityContractorOptionMenuBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityContractorOptionMenuBinding.inflate(getLayoutInflater());
        ...
        Glide.with(this)
                ...
                .into(new CustomViewTarget<ConstraintLayout, Drawable>(frameLayout) {
                    ...
                    public void onLoadFailed(@Nullable Drawable errorDrawable) {
                        Toast.makeText(Contractor_Option_Menu.this, "Load Failed", Toast.LENGTH_SHORT).show();
                    }
        ...
        binding.textView7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Contractor_Option_Menu.this, Contractor_Pre_View_Bid.class);
                startActivity(i);
            }
        });
