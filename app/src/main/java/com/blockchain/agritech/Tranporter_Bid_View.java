 ...
 */
public class Tranporter_Bid_View extends AppCompatActivity {
    /**
    ...
    private ActivityTranporterBidViewBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityTranporterBidViewBinding.inflate(getLayoutInflater());
